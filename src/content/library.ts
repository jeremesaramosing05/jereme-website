...
export const books: Book[] = [
  ...
  },
  {
    ...
    shelf: "comics",
    summary:
      "Children who cross rivers and climb mountains just to reach a classroom — a tender call to give every child a fair shot at learning.",
    hue: 205,
    cover: "/library/a-fair-shot.jpg",
    isMine: true,
    link: "/comics/a-fair-shot.pdf",
  },
  {
    ...
    shelf: "comics",
    summary:
      "A man rediscovers that the fullest life isn't built on having more, but on a heart that remembers to say thank you.",
    hue: 15,
    cover: "/library/the-thankful-heart.jpg",
    isMine: true,
    link: "/comics/the-thankful-heart.pdf",
  },
  {
    slug: "the-chocolate-puzzle",
    title: "The Chocolate Puzzle",
    author: "Jereme Saramosing",
    year: "2026",
    shelf: "comics",
    summary:
      "A chocolatier hides a secret code of love in every wrapper — a sweet, aching puzzle finally solved by a child he never met.",
    hue: 30,
    cover: "/library/the-chocolate-puzzle.jpg",
    isMine: true,
    link: "/comics/the-chocolate-puzzle.pdf",
  },
  {
    ...
    shelf: "comics",
    summary:
      "A small girl waits out the storm to learn the oldest, gentlest promise — every rain gives way to a rainbow.",
    hue: 190,
    cover: "/library/the-rainbow-after-the-rain.jpg",
    isMine: true,
    link: "/comics/the-rainbow-after-the-rain.pdf",
  },
  {
    slug: "the-ripple-of-a-smile",
    title: "The Ripple of a Smile",
    author: "Jereme Saramosing",
    year: "2026",
    shelf: "comics",
    summary:
      "One small act of caring passes from stranger to stranger — proof that a single smile can ripple farther than we'll ever see.",
    hue: 50,
    cover: "/library/the-ripple-of-a-smile.jpg",
    isMine: true,
    link: "/comics/the-ripple-of-a-smile.pdf",
  },
  // ── Design & Motion ──────────────────────────────────────────────
  {
